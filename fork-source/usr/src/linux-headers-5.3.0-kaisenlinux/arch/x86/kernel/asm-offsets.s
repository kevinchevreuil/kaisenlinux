...
.ascii "->"
# 0 "" 2
# arch/x86/kernel/asm-offsets_64.c:70: 	OFFSET(TSS_ist, tss_struct, x86_tss.ist);
# 70 "arch/x86/kernel/asm-offsets_64.c" 1
	
.ascii "->TSS_ist $36 offsetof(struct tss_struct, x86_tss.ist)"	#
# 0 "" 2
# arch/x86/kernel/asm-offsets_64.c:71: 	DEFINE(DB_STACK_OFFSET, offsetof(struct cea_exception_stacks, DB_stack) -
...
# 0 "" 2
# arch/x86/kernel/asm-offsets_64.c:73: 	BLANK();
# 73 "arch/x86/kernel/asm-offsets_64.c" 1
	
.ascii "->"
# 0 "" 2
# arch/x86/kernel/asm-offsets_64.c:76: 	DEFINE(stack_canary_offset, offsetof(struct fixed_percpu_data, stack_canary));
# 76 "arch/x86/kernel/asm-offsets_64.c" 1
	
.ascii "->stack_canary_offset $40 offsetof(struct fixed_percpu_data, stack_canary)"	#
# 0 "" 2
# arch/x86/kernel/asm-offsets_64.c:77: 	BLANK();
# 77 "arch/x86/kernel/asm-offsets_64.c" 1
	
.ascii "->"
# 0 "" 2
# arch/x86/kernel/asm-offsets_64.c:80: 	DEFINE(__NR_syscall_max, sizeof(syscalls_64) - 1);
# 80 "arch/x86/kernel/asm-offsets_64.c" 1
	
.ascii "->__NR_syscall_max $547 sizeof(syscalls_64) - 1"	#
# 0 "" 2
# arch/x86/kernel/asm-offsets_64.c:81: 	DEFINE(NR_syscalls, sizeof(syscalls_64));
# 81 "arch/x86/kernel/asm-offsets_64.c" 1
	
.ascii "->NR_syscalls $548 sizeof(syscalls_64)"	#
# 0 "" 2
# arch/x86/kernel/asm-offsets_64.c:83: 	DEFINE(__NR_syscall_compat_max, sizeof(syscalls_ia32) - 1);
# 83 "arch/x86/kernel/asm-offsets_64.c" 1
	
.ascii "->__NR_syscall_compat_max $435 sizeof(syscalls_ia32) - 1"	#
# 0 "" 2
# arch/x86/kernel/asm-offsets_64.c:84: 	DEFINE(IA32_NR_syscalls, sizeof(syscalls_ia32));
# 84 "arch/x86/kernel/asm-offsets_64.c" 1
	
.ascii "->IA32_NR_syscalls $436 sizeof(syscalls_ia32)"	#
# 0 "" 2
# arch/x86/kernel/asm-offsets_64.c:87: }
#NO_APP
	xorl	%eax, %eax	#
	ret	
	.size	main, .-main
...
.ascii "->PV_IRQ_irq_disable $312 offsetof(struct paravirt_patch_template, irq.irq_disable)"	#
# 0 "" 2
...
.ascii "->PV_IRQ_irq_enable $320 offsetof(struct paravirt_patch_template, irq.irq_enable)"	#
# 0 "" 2
# arch/x86/kernel/asm-offsets.c:71: 	OFFSET(PV_CPU_iret, paravirt_patch_template, cpu.iret);
# 71 "arch/x86/kernel/asm-offsets.c" 1
	
.ascii "->PV_CPU_iret $264 offsetof(struct paravirt_patch_template, cpu.iret)"	#
# 0 "" 2
...
.ascii "->PV_MMU_read_cr2 $392 offsetof(struct paravirt_patch_template, mmu.read_cr2)"	#
# 0 "" 2
